window.onload = function () {
  ...
  btn.onclick = function () {
    ...
    icon.onclick = function () {
       ...
       var deleteCheckbox = document.getElementById('checkbox');
      newTask.remove();
     console.log('delete');
    };
  };
  ...
  // TODO: complete all handler here
    ...
    completeAll.onclick = function () {
      var allTask = document.getElementById("container-to-do").getElementsByClassName("div");
      while(allTask.length > 0){
         allTask[0].parentNode.parentNode.label.classList.toggle('labeled');
    } 
